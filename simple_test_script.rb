...
visual_grid_runner = Applitools::ClassicRunner.new
...
begin
  ...
  driver.get('https://financialprofessionals.massmutual.com/eric-spindt')
  driver.manage.timeouts.implicit_wait = 30

  # check the login page with fluent api, see more info here
  # https://applitools.com/docs/topics/sdk/the-eyes-sdk-check-fluent-api.html
  eyes.check('Login page', Applitools::Selenium::Target.region(driver.find_element(:css,'#surveyModal\ Advisors---Subdomain-Survey\ 8ce1cdacbb3526753d3e')).fully(false))
